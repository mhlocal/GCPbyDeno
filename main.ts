...
const envUUID = Deno.env.get('UUID') || 'e8a38094-1499-4ed1-8c34-47433040bf8a';
const proxyIP = Deno.env.get('PROXYIP') || '';
const credit = Deno.env.get('CREDIT') || 'MH_Local';
...
<body>
    <div class="container">
        ...
        <div class="footer">
            Powered by Deno. For support, contact <a href="https://t.me/mhlocalnet" target="_blank">@modsbots_tech</a>.
        </div>
    </div>
</body>
</html>
...
<body>
    ...
    <div class="footer">
        Powered by Deno. For support, contact <a href="https://t.me/mhlocalnet" target="_blank">@mhlocalnet</a>.
    </div>
</body>
</html>
`;
